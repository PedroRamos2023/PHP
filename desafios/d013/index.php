...
<body>
    ...
    <main>
        ...
        <form action="<?=$_SERVER['PHP_SELF']?>" method="get">
            ...
            <p style="font-size: 0.6em"><sup>*</sup>Notas disponíveis: R$100, R$50, R$20, R$10, R$5, R$2 e R$1</p>
        ...
        <section>
            ...
            <ul>
                ...
                <li><img src="imagens/1-real.jpg" alt="Nota de 1" class="nota"> x<?=$tot1?></li>
            </ul>
        </section>
    </main>
</body>
